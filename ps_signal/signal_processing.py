...
class ps_signal():
    ...
    def plot_fft(self, filename=None, title="No title set",
                 filtered=False, ylim=None):
        """[summary]
        ...
        if filtered:
            ...
            plt.plot(self.fft_x_filt[:self._n // 2] / 1000,
            ...
            plt.plot(self.fft_x[:self._n // 2] / 1000,
